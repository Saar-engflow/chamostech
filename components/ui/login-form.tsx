...
/**
 * A glassmorphism-style login form component with animated labels and Supabase login.
 */
export function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Verify they're in the admins table
      console.log('Checking if user is in admins table...');
