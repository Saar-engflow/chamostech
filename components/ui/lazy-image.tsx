...
export function LazyImage({
	...
	return (
		...
		>
			...
			<div
				className={cn(
					'bg-gray-100 absolute inset-0 animate-pulse rounded-lg transition-opacity will-change-[opacity]',
					{ 'opacity-0': !isLoading },
				)}
			/>
			...
			{imgSrc && (
				<img
					...
					src={imgSrc}
					className={cn(
						'w-full h-full rounded-lg object-cover opacity-0 transition-opacity duration-500 will-change-[opacity]',
						{
