...
const ServiceCard = ({ service, index }: { service: Service, index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="relative flex h-[400px] w-full flex-col justify-between overflow-hidden rounded-3xl"
    >
      {/* Background Image */}
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4">
      ...
      >
        ...
        <CarouselNext className="bg-white/80 border border-gray-200 hover:bg-white text-primary-blue shadow-lg" />
      </Carousel>
    </div>
  );
};